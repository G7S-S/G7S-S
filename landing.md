...
<section id="two" class="spotlights">
	...
	<section>
		...
		<div class="content">
			<div class="inner">
				<header class="major">
					<h3>Exploratory Data Analysis Part - II</h3>
				</header>
	...
	<section>
		...
		<div class="content">
			<div class="inner">
				<header class="major">
					<h3>Revolutionising Requirements Engineering: Unleashing the Power of NLP and Generative AI</h3>
				</header>
				<p>This article reviews multiple advanced avenues powered by machine learning to perform text analytics on requirements documentation which is very important to ensure robust software development process. Various Machine learning enabled tools are listing along with its capabilities, also Generative AI is considered for the application which surprisingly also provides a well structured result for this application</p>
				<ul class="actions">
					<li><a href="https://www.linkedin.com/posts/gagan-s-shetty_nlp-gpt4-requirementsengineering-activity-7067074479792742401-68l7?utm_source=share&utm_medium=member_desktop" class="button">Learn more</a></li>
				</ul>
			</div>
		</div>
	</section>
